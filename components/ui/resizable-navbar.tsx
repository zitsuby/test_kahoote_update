...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      // IMPORTANT: Making the navbar fixed at the top of the page
  ...
  return (
    <motion.div
      animate={{
        ...
        padding: visible ? "8px 16px" : "12px 24px", 
...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      <span className="font-medium text-black dark:text-white">GolekQuiz</span>
    </a>
  );
};
